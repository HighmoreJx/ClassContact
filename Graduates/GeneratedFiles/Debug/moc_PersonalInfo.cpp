...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PersonalInfo_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 32, 0)
    ...
    "PersonalInfo\0saveInfoBtnClicked\0"
};
...
void PersonalInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->saveInfoBtnClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject PersonalInfo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PersonalInfo.data,
      qt_meta_data_PersonalInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PersonalInfo.stringdata))
        return static_cast<void*>(const_cast< PersonalInfo*>(this));
