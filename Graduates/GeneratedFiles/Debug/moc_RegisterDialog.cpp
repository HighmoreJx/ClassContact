...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RegisterDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 31, 16)
    ...
    "RegisterDialog\0sureBtnClicked\0\0"
    "cancelBtnClicked"
};
...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sureBtnClicked(); break;
...
const QMetaObject RegisterDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RegisterDialog.data,
      qt_meta_data_RegisterDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RegisterDialog.stringdata))
